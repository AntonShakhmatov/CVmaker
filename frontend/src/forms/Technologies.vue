...
<template>    
    <section class="mx-auto w-full max-w-2xl">
        <h1 class="text-3xl font-bold tracking-tight">Technologies</h1>
            <p class="mt-2 text-sm text-gray-600">Tech-stack</p>
            <input
                v-model="form.technologies_name"
                placeholder="Put here your tech-stack"
